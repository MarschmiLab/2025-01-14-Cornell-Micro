...
venue: "Cornell University"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Room MO1, 411 Tower Rd Stocking Hall, Ithaca, NY 14853"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "42.447150"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-76.471360"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Jan 14-15, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "8:30 am - 4:30 pm"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Sophia Aredas", "Alicia McElwee", "Augustus Pendleton", "Cassidy Prince", "Marian Schmidt"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
eventbrite: introductory-coding-workshop-software-carpentries-for-r-git-and-unix-tickets-1107071393339          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
{% if site.pilot %}
The lesson taught in this workshop is being piloted. The workshop will include regular breaks. Please <a href="mailto:{{page.email}}">contact the workshop organisers</a> if you would like more information about the planned schedule.
{% endif %}
